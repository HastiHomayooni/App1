  ...
  return (
    <>
      <div className='w-screen h-screen flex flex-col items-center'>
        ...
        <Link className='w-5/12 sm:w-3/12 mx-auto z-10 mt-auto mb-16' to={'/Account'}>
          <div
            className='rounded-3xl py-4 w-full bg-myDark hover:brightness-150 text-center text-lg text-white font-imprima'>Done
          </div>
        </Link>
