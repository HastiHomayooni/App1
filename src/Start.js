...
function Start(){
    ...
    return (
        <div className="flex flex-col px-4 items-center justify-center bg-myOrange h-screen w-screen">
            ...
            <div className='text-white font-Imprima text-center my-9 lg:my-7 text-xl lg:text-3xl'>We help you to find friends with similar personality near your location</div>
