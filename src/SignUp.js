                ...
                <div className='flex flex-col my-5 w-auto'>
                    <div className='flex flex-col w-auto my-2 md:flex-row'>
                        <div className='flex flex-col w-auto'>
                            ...
                            {name ==='' && (<div className='w-auto font-imprima text-left text-red-500 mx-2 md:px-6 px-3 text-xs'>You should fill the name.</div>)}
                            {name !=='' && !nameV && (<div className='w-auto font-imprima text-left text-red-500 mx-2 md:px-6 px-3 text-xs'>Invalid Name</div>)}
                        </div>
                        ...
                        <div className='flex flex-col w-auto'>
                            ...
                            {username ==='' && (<div className='w-auto font-imprima text-left text-red-500 mx-2 md:px-6 px-3 text-xs'>You should fill the username.</div>)}
                            {username !=='' && !usernameV && (<div className='w-auto font-imprima text-left text-red-500 mx-2 md:px-6 px-3 text-xs'>Invalid Username</div>)}
                        </div>                        
                    </div>
